  ...
  <div id="appCapsule">
    ...
    <div class="section mt-2">
      <div class="profile-head">
        <div class="avatar">
          <img src="../assets/avatar1.jpg" alt="avatar" class="imaged w64 rounded">
        </div>
        <div class="in">
          <h3 class="name">جولیان گرابر</h3>
          <h5 class="subtext">طراح</h5>
        </div>
      </div>
    </div>
    ...
    <div class="section full mt-2">
      <div class="profile-stats ps-2 pe-2">
        <a href="#" class="item">
          <strong>152</strong>تصویر
        </a>
        <a href="#" class="item">
          <strong>52</strong>آلبوم
        </a>
        <a href="#" class="item">
          <strong>27k</strong>دنبال کننده
        </a>

        <a href="#" class="item">
          <strong>506</strong>دنبال شونده
        </a>
      </div>
    </div>
    ...
    <div class="section full">
      <div class="wide-block transparent p-0">
        <ul class="nav nav-tabs lined iconed" role="tablist">
          <li class="nav-item">
            <p class="nav-link active" data-bs-toggle="tab" href="#feed" role="tab">
              <ion-icon name="grid-outline"></ion-icon>
            </p>
          </li>
          <li class="nav-item">
            <p class="nav-link" data-bs-toggle="tab" href="#friends" role="tab">
              <ion-icon name="people-outline"></ion-icon>
            </p>
          </li>
          <li class="nav-item">
            <p class="nav-link" data-bs-toggle="tab" href="#bookmarks" role="tab">
              <ion-icon name="bookmark-outline"></ion-icon>
            </p>
          </li>
          <li class="nav-item">
            <p class="nav-link" data-bs-toggle="tab" href="#settings" role="tab">
            ...
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    ادوارد لینگرین
                    <div class="text-muted">532 دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    املدا اسکاندروت
                    <div class="text-muted">120k دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    هنری بوو
                    <div class="text-muted">920k دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    آوا گرگوراچی
                    <div class="text-muted">5092 دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    امی السنر
                    <div class="text-muted">92 دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    لیزان ویسکال
                    <div class="text-muted">893 دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    سیسیلیا پوزو
                    <div class="text-muted">51k دنبال کننده</div>
                  </div>
                </div>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    پرندگان
                    <div class="text-muted">62 تصویر</div>
                  </div>
            ...
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    خیابان ها
                    <div class="text-muted">15 تصویر</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    سگ ها
                    <div class="text-muted">97 تصویر</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    مورد علاقه
                    <div class="text-muted">20 تصویر</div>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="#" class="item">
                ...
                <div class="in">
                  <div>
                    طبیعت
                    <div class="text-muted">51 تصویر</div>
                  </div>
                </div>
              </a>
            </li>
        ...
        <div class="tab-pane fade" id="settings" role="tabpanel">
          <ul class="listview image-listview text flush transparent pt-1">
            <li>
              <div class="item">
                <div class="in">
                  <div>
                    بیصدا
                    <footer>اعلان‌های این شخص را غیرفعال کنید</footer>
                  </div>
            ...
            <li>
              <a href="#" class="item">
                <div class="in">
                  <div class="text-danger">مسدود</div>
                </div>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#" class="item">
                <div class="in">
                  <div>این نمایه را به اشتراک بگذارید</div>
                </div>
              </a>
            </li>
            <li>
